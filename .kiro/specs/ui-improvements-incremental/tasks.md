...
- [x] 7. Atualizar GlobalStyles para Tailwind v4
  - [x] 7.1 Configurar imports do Tailwind v4
  ...
  - [x] 7.2 Configurar @source directives
  ...
  - [x] 7.3 Definir custom variant para dark mode
    - Adicionar @custom-variant dark (&:is(.dark *))
    - Testar que variant funciona com classes dark:
    - _Requirements: 4.3_
  
  - [x] 7.4 Configurar theme tokens com @theme inline
  ...
  - [x] 7.5 Definir CSS custom properties para light theme
    - Criar seletor :root
  ...
  - [x] 7.6 Definir CSS custom properties para dark theme
    - Criar seletor .dark
  ...
  - [x] 7.7 Definir utility classes customizadas
  ...
  - [x] 7.8 Estilizar scrollbar customizada
  ...
  - [x] 7.9 Definir headings responsivos
  ...
  - [x] 7.10 Definir estilos para .post-content
  ...
  - [x] 7.11 Adicionar animação shine otimizada
  ...
  - [x] 7.12 Adicionar suporte a prefers-reduced-motion
